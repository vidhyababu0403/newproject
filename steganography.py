...
#icon
image_icon=PhotoImage(file="C:/Users/kutty/Downloads/logo.jpg")
...
logo=PhotoImage(file="C:/Users/kutty/Pictures/logo1.png")
...
lbl.place(x=40,y=10)
#second frame
frame2=Frame(root,bd=3,width=340,height=280,bg="pink",relief=GROOVE)
